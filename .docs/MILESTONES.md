...
## M40 — Category question-type filter (2026-09-24)

[T40 contract](T40-QUESTION-TYPE-FILTER.md) governs this sequence. M40-A (T40.1–3) enters after current release/metadata inspection and database/security boundary review; it exits with a deterministic release-bound aggregate and local/Firebase projection checks. M40-B (T40.4–5) depends on M40-A; it exits with accessible host filtering, integrated tests, independent release Gate and exact production readback. Both milestones are authorized; status: M40-A Done after root acceptance and Security/Database review; M40-B implementation and Gate PASS, production publication/readback pending standard Admin SDK credentials. No active-release mutation or room rule change.

# M39 — Admin category inspection and correction (2026-09-24)

Entry: T27 admin dashboard exists; current active release is immutable. Ordered tasks are [T39.1 browse/details](T39-ADMIN-CATEGORY-INSPECTION.md#t391--published-category--questions-inspection), [T39.2 correction entry](T39-ADMIN-CATEGORY-INSPECTION.md#t392--category-correction-entry), and [T39.3 integration/release](T39-ADMIN-CATEGORY-INSPECTION.md#t393--integration-and-production). T39.1 and T39.2 are Done after root acceptance; Security and independent technical Gate passed. T39.3 is published via merged [PR #4](https://github.com/sanadii/huroof-wa-oloof/pull/4), targeted ACTIVE Firebase Functions and Ready Vercel production readback. Its final signed-in desktop/mobile acceptance remains open because the available browser session is a guest. Exit: category-specific question inspection and the resolved editing model pass the documented criteria, with production readback. Root owns final status; Forge owns assigned implementation/check evidence.

The user authorized [T39.4](T39-ADMIN-CATEGORY-INSPECTION.md#t394--category-question-inspection-workflow-authorized-2026-09-24) on 2026-09-24. Entry: existing published-detail route and scoped release reads; Database/Security boundary reviews complete. Exit: stable category-local previous/next, publishable cover and label, create-once release-bound reviewed check with immediate post-save advance, role/gate/race tests, desktop/mobile inspection. State: authorized implementation, assigned to Forge. [T39.5](T39-ADMIN-CATEGORY-INSPECTION.md#t395--integrated-release-and-production-readback) requires T39.4 root acceptance and independent Gate before production enablement; state: authorized, pending prerequisite. Rollback disables the dedicated mark gate without changing release content.

T39.4 is Done — root accepted 2026-09-24 after focused checks, independent Gate PASS, and signed-in local readback against production Functions. T39.5 GitHub/Vercel and targeted Firebase deployment are complete through merged [PR #8](https://github.com/sanadii/huroof-wa-oloof/pull/8), Ready production deployment `dpl_5SvtoytMWQS1WojhVerdQAf7DczB`, and dedicated inspection gate enablement. A real production-origin mark/reload/advance and human mobile visual approval remain open; no published question was marked solely to test deployment. [Exact evidence and rollback](T39-ADMIN-CATEGORY-INSPECTION.md#t395--integrated-release-and-production-readback).

**M39-C / T39.6** (authorized 2026-09-25): entry requires the existing T39.4 marker and read boundary plus Security/Database review of the additive list projection. One implementation milestone covers T39.6a–d in the [T39 contract](T39-ADMIN-CATEGORY-INSPECTION.md#t396--persistent-published-question-list-and-inspection-dialog-authorized-2026-09-25). Exit requires a validated bounded status projection, URL-addressable accessible dialog with persistent list state, truthful counts, focused Functions/UI/emulator checks and signed-in desktop/mobile evidence. State: **Done, root accepted 2026-09-25** after independent Gate PASS and local rendered readback; [exact evidence](T39-ADMIN-CATEGORY-INSPECTION.md#t396--persistent-published-question-list-and-inspection-dialog-authorized-2026-09-25). **M39-D / T39.7** depends on M39-C root acceptance and independent release Gate; it exits after compatible backend-then-client deployment and exact production readback. State: pending T40.5 production dependency and release checks. Older T39.5 open human acceptance remains open.
