...
export type PublishedQuestionDetail = PublishedQuestionSummary & { releaseId: string; promptAr?: string; canonicalAnswer?: string; acceptedAnswers?: string[]; media?: { mediaId: string | null; type: string | null; contentType: string | null; altAr: string | null; assetSha256: string | null } | null; answerMedia?: { mediaId: string | null; type: string | null; contentType: string | null; altAr: string | null; assetSha256: string | null } | null };
